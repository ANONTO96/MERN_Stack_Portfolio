          ...
          <div className="bg-white p-8 mb-6 rounded-2xl shadow-sm space-y-8" style={{backgroundImage: `url(${bg})`}}>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="mailto:tanjirulanonto48@gamil.com" className="text-indigo-600 hover:text-indigo-700">
                  tanjirulanonto48@gamil.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="tel:+8801606074498" className="text-indigo-600 hover:text-indigo-700">
                  +8801606074498
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="https://wa.me/+8801606074498" className="text-indigo-600 hover:text-indigo-700">
                +8801606074498
                </a>
              </div>
            </div>
