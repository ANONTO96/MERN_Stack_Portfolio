...
const Hero = () => {
  return (
    <section id="home" className="pt-20 py-32 sm:py-20 bg-gradient-to-br from-indigo-300 via-white to-purple-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <div className="flex gap-4 justify-center">
                <a href="https://github.com/ANONTO96" target="_blank" rel="noopener noreferrer"
                  className="p-3 bg-slate-100 rounded-full hover:bg-gray-200 transition">
          ...
          <div className="md:w-1/2 mt-12 md:mt-0 md:pl-20">
            <img
              src={image}
              className="rounded-full w-72 h-72 object-cover mx-auto border-8 border-white shadow-xl hover:shadow-2xl"
            />
          </div>
        </div>
      </div>
