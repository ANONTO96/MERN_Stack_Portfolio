...
import Project1 from "../assets/Screenshot 2025-03-12 225948.png";
import Project2 from "../assets/Romantic Wedding Moment.jpeg";
import Project3 from "../assets/Colorful Office Supplies.jpeg";
import Project4 from "../assets/DALL·E 2024-12-04 19.37.36 - A banner image for a crowdfunding website focused on unity and pledges for donations. The scene shows a diverse group of people holding hands in a lar.webp";
...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      githubLink: "https://github.com/ANONTO96/Unity-Pledge-Client",
